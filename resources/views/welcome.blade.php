...
<body class="overflow-hidden">
    ...
    <div class="fixed inset-0 overflow-hidden">
        <!-- Animated circles -->
        <div
            class="absolute -top-40 -right-40 w-80 h-80 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float">
        </div>
        <div
            class="absolute -bottom-40 -left-40 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse-slow">
        </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5 ">
                                    <input id="remember" type="checkbox" name="remember"
                                        class="w-4 h-4 border border-gray-300 rounded !bg-transparent cursor-pointer" />
                                </div>
                                <label for="remember" class="ms-2 text-sm font-normal text-gray-900 cursor-pointer">Remember me</label>
                            </div>
                            <button type="submit"
                                class="w-full text-white bg-blue-600 hover:bg-blue-700 transition duration-300 ease-in-out focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-blue-400 cursor-pointer">
                                Masuk
                            </button>
                            <div class="text-sm text-center text-gray-700 mt-2">
                                Belum punya akun Guru? <a href="{{ url('/registrasi') }}"
